...
async function downloadCard() {
  ...
  try {
    const renderEl = document.getElementById('cardRenderEl');
    
    // Tentukan ukuran target unduhan (lebar pixel)
    const targetWidth = 1080;
    const scale = targetWidth / renderEl.offsetWidth;

    // Pastikan scroll container tidak memotong elemen
    window.scrollTo(0, 0);
